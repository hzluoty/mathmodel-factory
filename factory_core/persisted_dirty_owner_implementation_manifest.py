...
TRUSTED_PERSISTED_DIRTY_OWNER_SYMBOLS_V1 = (
    PythonSymbolSourceSpanV1(
        ...
        qualified_symbol='_SOLVER_RECEIPT_RE',
        source_span_schema='python-ast-source-span-v1',
        start_line=85,
        end_line=87,
        byte_size=116,
        source_sha256='9d2d29107e621a4091e11a5c1857c91ded83f879b4a4e3583822b7a8ea25c425',
    ),
    PythonSymbolSourceSpanV1(
        relative_path='factory_core/dirty.py',
        qualified_symbol='solver_receipt_job_id',
        source_span_schema='python-ast-source-span-v1',
        start_line=153,
        end_line=157,
        byte_size=262,
        source_sha256='f90dcd0d746a2f1bfceeef9ae839166e2c7faf11ffe6f8047a495747c37c9b98',
    ),
    PythonSymbolSourceSpanV1(
        relative_path='factory_core/engine.py',
        qualified_symbol='FactoryEngine._solver_receipt_owner_stage',
        source_span_schema='python-ast-source-span-v1',
        start_line=927,
        end_line=938,
        byte_size=475,
        source_sha256='935d124f1b3ad646e173601ee267353c8fa70a7e03d2c6cf88e50a1d41a3b5ef',
    ),
    PythonSymbolSourceSpanV1(
        relative_path='factory_core/engine.py',
        qualified_symbol='FactoryEngine._stage_manifest_delta',
        source_span_schema='python-ast-source-span-v1',
        start_line=878,
        end_line=925,
        byte_size=2125,
        source_sha256='0fb1180a78fca5d4eea900b5d58c70b97e5cb3c3d74fc6b7f1c0c959b77dca89',
    ),
    PythonSymbolSourceSpanV1(
        relative_path='factory_core/storage.py',
        qualified_symbol='SQLiteStateStore._solver_job_from_row',
        source_span_schema='python-ast-source-span-v1',
        start_line=3920,
        end_line=3943,
        byte_size=1122,
        source_sha256='e6d8ada2957c8c010ca493a13417bcd2c15f53d8f1f0b4bddc796d8a14ecd4b7',
    ),
    PythonSymbolSourceSpanV1(
        relative_path='factory_core/storage.py',
        qualified_symbol='SQLiteStateStore.solver_job',
        source_span_schema='python-ast-source-span-v1',
        start_line=3890,
        end_line=3898,
        byte_size=411,
        source_sha256='37c3f90266defd8b623f5d52bb55f11250422f4604e18453313687caf6b125a9',
    ),
)
