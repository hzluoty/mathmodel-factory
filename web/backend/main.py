...
get_contest_dashboard = _router_endpoint(project_router, "/api/projects/{base_name}/contest-dashboard")
...
get_submission = _router_endpoint(project_router, "/api/projects/{base_name}/submission")
