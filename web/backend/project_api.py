...
def _runtime_to_project_status(runtime: dict[str, Any], project: Path | None = None) -> ProjectStatus:
    ...
    return ProjectStatus(
        ...
        scheduler_generation=runtime.get("scheduler_generation"),
        stage_catalog_version=runtime.get("stage_catalog_version"),
        last_completed_stage=runtime.get("last_completed_stage"),
        active_stage=runtime.get("active_stage"),
        active_stage_name=runtime.get("active_stage_name"),
        active_subtask=runtime.get("active_subtask"),
        source_step_id=runtime.get("source_step_id"),
