...
assert.equal(projectStepName({...run, current_step: 16, source_step_id: 16}), '编译·打包')
assert.equal(projectStepName({...run, status: 'failed', current_step: 16, source_step_id: 16}), '编译·打包')
